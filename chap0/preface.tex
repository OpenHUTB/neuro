...
\caption{名词中英对照表 \label{tab:0_1}} \\
 ...
 英文（缩略词）   && 中文 \\
 	...
 	\midrule
 	$\gamma$-aminobutyric acid     && $\gamma$－氨基丁酸   \\
	...
	\midrule
	paramedian pontine reticular formation (PPRF)     && 桥旁正中网状结构   \\
	
	\midrule
	Parasol ganglion cells     && 伞状神经节细胞   \\
