...
\caption{名词中英对照表 \label{tab:0_1}} \\
 ...
 英文（缩略词）   && 中文 \\
 	...
 	\midrule
 	7q11.23    && \makecell{第7号染色体\\1区1带\\2亚带3次亚带}   \\
 	
 	% 阿尔茨海默病
 	\midrule
 	\makecell{$\alpha$-amino-3-hydroxy-5-\\methyl-4-isoxazolepropionic acid (AMPA)}   && \makecell{$\alpha$-氨基-3-羟基-5-\\甲基异恶唑-4-丙酸}   \\
	...
	\midrule
	\makecell{Attention deficit hyperactivity\\ disorder (ADHD)}     && 注意缺陷多动障碍   \\
	...
	\midrule
	\makecell{autosomal dominant nocturnal \\ frontal lobe epilepsy (ADNFLE)}    && \makecell{常染色体显性遗传\\夜间额叶癫痫}   \\
	...
	\midrule
	\makecell{Calcium-calmodulin (CaM)-dependent \\protein kinase II (CaMKII)}   && \makecell{钙/钙调蛋白\\依赖性蛋白激酶 2}  \\
	
	\midrule
	calmodulin (CaM)   && 钙调蛋白  \\
	
	\midrule
	\makecell{cAMP response element binding\\ protein (CREB)}  && \makecell{环磷酸腺苷应答元件\\结合蛋白}  \\
	...
	\midrule
	\makecell{continuous positive airway \\ pressure (CPAP)}     && 持续气道正压  \\
	...
	\midrule
	\makecell{generalized epilepsy with febrile \\ seizures plus (GEFS+ syndrome)}     &&  \makecell{全面性癫痫伴热性\\惊厥附加综合症}  \\
	...
	\midrule
	\makecell{glial cell line–derived \\ neurotrophic factor (GDNF) }    &&  胶质细胞源性神经营养因子  \\
	...
	\midrule
	\makecell{hyperpolarization-activated cyclic \\nucleotide-gated channel (HCN)}     &&  \makecell{超极化激活环核苷酸\\门控阳离子通道}  \\
	...
	\midrule
	\makecell{non-voltage-activated sodium \\leak nonselective (NALCN)}  && \makecell{非电压激活钠\\泄漏非选择性} \\
	...
	\midrule
	\makecell{sexually dimorphic nucleus of\\ the preoptic area (SDN-POA)}   && 视前区性二态核团 \\
	...
	\midrule
	\makecell{single-photon emission \\computed tomography (SPECT)} && 单光子发射计算机断层扫描 \\
	...
	\midrule
	\makecell{soluble N-ethylmaleimide-sensitive \\factor attachment receptors (SNAREs)}   && \makecell{可溶性N-乙基马来酰亚胺\\敏感因子附着受体} \\
	...
	\midrule
	\makecell{Speech Interpretation \& \\Recognition Interface (Siri)}  && 语音识别接口 \\
	...
	\midrule
	\makecell{spinal nucleus of the\\ bulbocavernosus (SNB)}  && 球海绵体肌脊髓核 \\
	...
	\midrule
	\makecell{transmembrane AMPA receptor\\ regulatory proteins (TARP)}  && 跨膜AMPA受体调控蛋白  \\
