...
\institute{\href{https://github.com/OpenHUTB/neuro}{OpenHUTB}}
\bioinfo{\href{2929@hutb.edu.cn}{反馈}}{\href{https://github.com/OpenHUTB/neuro/issues}{记录内容修改}}
\date{\today}
% \version{3.2}
...
% 文本框中一级标题颜色参考模板中“定义”的底色：
% \textcolor[HTML]{00A652}{一级标题}
% 文本框中二级标题颜色参考模板中“文本框”的底色：
% \textcolor[HTML]{00AEF7}{二级标题}
